...
public class BuildOutfitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (editOutfitId != null) {
            WardrobeRepository.getInstance(this).getOutfitById(editOutfitId, existing -> {
                if (existing != null) {
        ...
        buttonOpenWardrobe.setOnClickListener(v -> {
            WardrobeRepository.getInstance(this).getAllItems(allItems -> {
        ...
        buttonSave.setOnClickListener(v -> {
            ...
            if (editOutfitId != null) {
                WardrobeRepository.getInstance(this).updateOutfit(editOutfitId, outfit);
            } else {
                WardrobeRepository.getInstance(this).addOutfit(outfit);
            }
            setResult(RESULT_OK);
            finish();
        });
